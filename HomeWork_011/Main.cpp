...
int main()
{
    ...
    //cout << "\nМассив double до разброса элементов\n";
    //show_array(arr_g, COD);
    //random_mixing(arr_g, t_arr, COD);
    //cout << "\nМассив double после разброса элементов\n";
    //show_array(arr_g, COD);
